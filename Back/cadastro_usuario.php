...
if ($stmt_usuario) {
    if ($fk_tipo_usuario === TIPO_CLIENTE) {
        echo "<script>alert('Cadastro realizado com sucesso!'); window.location.href = '../Front/Pages/index.html';</script>";
        exit;
    } else {
        echo "<script>alert('Colaborador cadastrado com sucesso!'); window.location.href = '../Front/Pages/cadastro-usuario.php';</script>";
        exit;
    }
} else {
